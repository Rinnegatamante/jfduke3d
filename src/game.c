...
#define MINITEXT_SBAR 256
#define MINITEXT_FBAR 512
...
int minitext(int x,int y,const char *t,unsigned char p,short sb)
{
    ...
    while(*t)
    {
        ...
        if (cmode == (MINITEXT_SBAR>>8)) statusbarsprite(x,y,65536L,0,ac,0,p,sb,0,0,xdim-1,ydim-1);
        else if (cmode == (MINITEXT_FBAR>>8)) fragbarsprite(x,y,65536L,0,ac,0,p,sb,0,0,xdim-1,ydim-1);
...
int minitextshade(int x,int y,const char *t,char s,unsigned char p,short sb)
{
    ...
    while(*t)
    {
        ...
        if (cmode == (MINITEXT_SBAR>>8)) statusbarsprite(x,y,65536L,0,ac,s,p,sb,0,0,xdim-1,ydim-1);
        else if (cmode == (MINITEXT_FBAR>>8)) fragbarsprite(x,y,65536L,0,ac,s,p,sb,0,0,xdim-1,ydim-1);
